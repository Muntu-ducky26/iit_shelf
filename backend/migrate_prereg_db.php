...
$mainDbName = getenv('DB_NAME') ?: 'iit_shelf';
$preRegDbName = getenv('DB_PREREG_NAME') ?: 'iit_shelf_prereg';

$mainDb = new PDO(
    "mysql:host={$dbHost};dbname={$mainDbName}",
    $dbUser,
    $dbPass
);
...
$preRegDb = new PDO(
    "mysql:host={$dbHost};dbname={$preRegDbName}",
    $dbUser,
    $dbPass
);
