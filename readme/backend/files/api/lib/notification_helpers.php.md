...
## Overview
- Source file: backend\api\lib\notification_helpers.php
- Category: Shared Backend Library
- Purpose: Provides shared helper logic for: notification helpers.

## What Is Done In This File
- Implements backend logic for notification helpers.
