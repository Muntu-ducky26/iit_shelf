...
## Overview
- Source file: backend\tcpdf\fonts\kozminproregular.php
- Category: TCPDF Library File
- Purpose: TCPDF library implementation file for: kozminproregular.

## What Is Done In This File
- Implements backend logic for kozminproregular.
