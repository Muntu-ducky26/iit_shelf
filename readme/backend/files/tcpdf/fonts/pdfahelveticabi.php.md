...
## Overview
- Source file: backend\tcpdf\fonts\pdfahelveticabi.php
- Category: TCPDF Library File
- Purpose: TCPDF library implementation file for: pdfahelveticabi.

## What Is Done In This File
- Implements backend logic for pdfahelveticabi.
